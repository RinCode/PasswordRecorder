 ...
 *http://blog.csdn.net/u010156024/article/details/45673581
 */
...
public class PasswdStrength {
    ...
    public PasswdStrength(String psw) {
    ...
    public int score() {
        int result;
        result = CheckPswLength() + CheckPswUpper() + CheckPwsLower() + checkNum() + checkChar() + checkNumOrCharInStr() + LowerQuest() + OnlyHasAlp() + OnlyHasNum() + repeatDex() + seriseUpperAlp() + seriseLowerAlp() + seriseNum() + seriesAlp2Three() + seriesNum2Three();
        return result;
    }
